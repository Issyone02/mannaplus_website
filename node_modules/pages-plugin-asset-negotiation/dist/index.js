...
var isImage = /* @__PURE__ */ __name((file) => {
  const ext = file.split(".").pop();
  return Boolean(mimetypeMap[ext]);
}, "isImage");
var onRequest = /* @__PURE__ */ __name(async ({ env, next, pluginArgs = {}, request }) => {
...
// ../.wrangler/tmp/pages-WeaYqz/functionsRoutes-0.16113998652626638.mjs
var routes = [
  {
    routePath: "/",
    mountPath: "/",
